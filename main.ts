...
let obstacleBottomImgs = [img`
    ...
    ......ee6eeeeee6eef.....
    `]
duck = sprites.create(duckAnimationFrames[0], SpriteKind.Player)
scene.setBackgroundColor(9)
effects.blizzard.startScreenEffect()
duck.ay = 300
let flapAnimation = animation.createAnimation(ActionKind.Jumping, 25)
for (let frame of duckAnimationFrames) {
    flapAnimation.addAnimationFrame(frame)
}
animation.attachAnimation(duck, flapAnimation)
game.onUpdate(function () {
    if (duck.y > 120 || duck.y < 0) {
        game.over(false)
    }
})
game.onUpdateInterval(1500, function() {
    ...
    let topProjectile = sprites.createProjectileFromSide(topImage, -40, 0)
    let bottomProjectile = sprites.createProjectileFromSide(bottomImage, -40, 0)
    topProjectile.top = 0
